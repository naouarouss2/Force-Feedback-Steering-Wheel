...
static void MX_GPIO_Init(void)
{
  ...
  /* EXTI interrupt init*/
  HAL_NVIC_SetPriority(BUTTON_A_EXTI_IRQn, 6, 0);
  HAL_NVIC_EnableIRQ(BUTTON_A_EXTI_IRQn);

  HAL_NVIC_SetPriority(E_STOP_EXTI_IRQn, 13, 0);
  HAL_NVIC_EnableIRQ(E_STOP_EXTI_IRQn);

  HAL_NVIC_SetPriority(ENCODER_Z_EXTI_IRQn, 13, 0);
  HAL_NVIC_EnableIRQ(ENCODER_Z_EXTI_IRQn);
